...
type HyperArg <Element extends HTMLElement> = ElementAttributes<Element>|HyperElement|HyperElement[]|HTMLElement|string|boolean|null|undefined
export type HyperArgs<Element extends HTMLElement> = HyperArg<Element>[]

export function isChildArg(arg: HyperArg<never>){
	return ['string', 'boolean', 'undefined'].includes(typeof arg) || arg === null || arg instanceof HyperElement || Array.isArray(arg) || arg instanceof HTMLElement;
}
