...
import migration1 from "../../logic/database/migrations/00-setup.sql?raw"

import {fieldsVersions, fields} from "../../logic/database/schema/fields/database.ts";
import {contentItems, contentItemsVersions} from "../../logic/database/schema/content-items/database.ts";
import {contentTypes, contentTypesVersions} from "../../logic/database/schema/content-types/database.ts";
import {views, viewsVersions} from "../../logic/database/schema/views/database.ts";

import {CreateFieldDto, FieldDto, FieldVersionDto, UpdateFieldDto} from "../../logic/database/schema/fields/dtos.ts";
...
} from "../../logic/database/schema/content-types/dtos.ts";
import {
	ContentItemDto, ContentItemVersionDto,
	CreateContentItemDto,
	UpdateContentItemDto
} from "../../logic/database/schema/content-items/dtos.ts";
import {CreateViewDto, UpdateViewDto, ViewDto, ViewVersionDto} from "../../logic/database/schema/views/dtos.ts";
