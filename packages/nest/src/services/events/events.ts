...
export type ExternalServerEvent = UserUpdateEvent | UserDeleteEvent | VaultCreateEvent | VaultUpdateEvent | VaultDeleteEvent | FileCreateEvent | FileDeleteEvent | ChunkCreateEvent | ChunkDeleteEvent;
